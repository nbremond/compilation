...
static const yytype_uint8 yyprhs[] =
{
     ...
     189,   197,   203,   211,   218,   221,   225,   227,   230,   232,
     234
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      28,     3,    -1,     3,    23,     4,    24,    -1,    47,    21,
      48,    22,    -1,    47,    21,    22,    -1,    49,    -1,    48,
      25,    49,    -1,    46,    47,    -1,    51,    -1,    54,    -1,
      55,    -1,    56,    -1,    57,    -1,    34,    35,    -1,    34,
      53,    35,    -1,    34,    52,    53,    35,    -1,    44,    -1,
      52,    44,    -1,    50,    -1,    53,    50,    -1,    33,    -1,
      43,    33,    -1,    15,    21,    43,    22,    50,    -1,    15,
      21,    43,    22,    50,    16,    50,    -1,    17,    21,    43,
      22,    50,    -1,    19,    21,    54,    54,    43,    22,    50,
      -1,    20,    50,    17,    21,    43,    22,    -1,    18,    33,
      -1,    18,    43,    33,    -1,    59,    -1,    58,    59,    -1,
      60,    -1,    44,    -1,    46,    47,    51,    -1
};
...
static const yytype_uint8 yyrline[] =
{
      ...
      45,    49,    50,    54,    55,    56,    60,    61,    65,    66,
      67,    71,    72,    73,    74,    75,    76,    77,    81,    82,
      83,    87,    91,    92,    96,    97,    98,   102,   103,   104,
...
/* Line 1792 of yacc.c  */
#line 102 "parser.y"
    { (yyval.t).kind = base; (yyval.t).taille = 0; (yyval.t).isFunction = 0;}
    break;

  case 38:
/* Line 1792 of yacc.c  */
#line 103 "parser.y"
    { (yyval.t).kind = base+2; (yyval.t).taille = 0; (yyval.t).isFunction = 0;}
    break;

  case 39:
/* Line 1792 of yacc.c  */
#line 104 "parser.y"
    { (yyval.t).kind = base; (yyval.t).taille = (yyvsp[(3) - (4)].n); (yyval.t).isFunction = 0; }
    break;

  case 40:
/* Line 1792 of yacc.c  */
#line 105 "parser.y"
    { (yyval.t) = (yyvsp[(1) - (4)].t); (yyval.t).taille = 0; (yyval.t).isFunction = 1; (yyval.t).nbParam = np; memcpy((yyval.t).params, (yyvsp[(3) - (4)].pl), sizeof(enum primitif)*np);}
    break;

  case 41:
/* Line 1792 of yacc.c  */
#line 106 "parser.y"
    { (yyval.t) = (yyvsp[(1) - (3)].t); (yyval.t).taille = 0; (yyval.t).isFunction = 1; (yyval.t).nbParam = 0; }
    break;

  case 42:
/* Line 1792 of yacc.c  */
#line 110 "parser.y"
    { np = 1; (yyval.pl)[np] = base;}
    break;

  case 43:
/* Line 1792 of yacc.c  */
#line 111 "parser.y"
    { memcpy((yyval.pl), (yyvsp[(1) - (3)].pl), sizeof(enum primitif)*np); (yyval.pl)[np++] = base; }
    break;

  case 44:
/* Line 1792 of yacc.c  */
#line 115 "parser.y"
    { (yyval.pdcl) = (yyvsp[(2) - (2)].t); }
    break;
